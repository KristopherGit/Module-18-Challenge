...
input_sender = st.text_input("Sender Address:")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_receiver = st.text_input("Receiver Address:")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_amount = st.text_input("Transfer Amount (₿):")
...
if st.button("Add Block"):
    ...
    new_block = Block(
        record=Record(sender=input_sender,
                      receiver=input_receiver, amount=input_amount),
        creator_id=42,
